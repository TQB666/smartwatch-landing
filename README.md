...
- **Tối ưu SEO:** Cấu hình đầy đủ các thẻ HTML 9Meta, Title, Description và Open Graph để chia sẻ mượt mà trên các mạng xã hội.
...
- **Tích hợp Backend Firebase:** Dữ liệu đăng ký bản tin (Newsletter) và Đơn hàng mua (Checkout form gồm Tên, SĐT) được đẩy thẳng lên Firestore Database theo thời gian thực.
